...
- Источники аудитории. Список пользователей. Создание списка. После загрузка списка при нажатой галочке "Как имя файла" название списка совпадает с файлом.
...
- Сортировка. Сортировка по столбцам с датами располагает данные в хронологическом порядке.
...
### Списки пользователей. Список списков.

- Сортировка. Сортировка по текстовым столбцам располагает данные в алфавитном порядке.
- Сортировка. Сортировка по числовым столбцам располагает данные в порядке возрастания.
- Сортировка. Сортировка по столбцам с датами располагает данные в хронологическом порядке.
- Удаление аудитории. После удаления список не отображается в списке списков.
- Удаление списка. Если список используется в аудитории, то его нельзя удалить.
